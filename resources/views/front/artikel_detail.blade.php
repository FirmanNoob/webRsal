...
<section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url('images/halamandepan1.jpg');" data-stellar-background-ratio="0.5">
		...
		<section class="ftco-section">
            ...
            <h2 class="mb-3">{{$artikel_detail->judul}}</h2>
            <p>
            <img class="img-responsive" src="{{ asset('images/'.$artikel_detail->gambar) }}" width="600px" height="600px" alt="">
            </p>
            <p>{!! $artikel_detail->body !!}</p>
            <p>
